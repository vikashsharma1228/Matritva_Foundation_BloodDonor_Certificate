...
public class EmailService {
    ...
    @Async
    // Parameters badal diye hain: venue, date, aur totalDonations add kiya hai
    public void sendEmailWithAttachment(String toEmail, String donorName, byte[] pdfContent,
        ...
        try {
            ...
            // Subject mein Location add karne se personal touch aata hai
            ...
            String htmlBody = "<div style='font-family: \"Segoe UI\", Tahoma, sans-serif; line-height: 1.6; color: #1a1a1a; max-width: 600px; margin: auto; border: 1px solid #f0f0f0; border-radius: 15px; overflow: hidden;'>"
                    ...
                    // --- THE IMPACT STATS BOX (Attractive Element) ---
                    ...
                    +
                    "<p style='font-size: 12px; color: #800000; margin: 5px 0;'><b>📍Donation Location: " + location
                    + "</b></p>" + "<p style='font-size: 12px; color: #800000; margin: 5px 0;'><b>📅 Donation Date:"
                    + donationDate + "</b></p>" +
                    "<p style='font-size: 10px; color: #800000; margin: 5px 0;'><b>🩸Your Total Blood Donation: "
                    + donationCount + " times</b></p>" +
                    "</div>" +
                    ...
                    // WhatsApp Button
                    "<a href='" + whatsappLink
                    + "' style='background-color: #25D366; color: white; padding: 12px 25px; text-decoration: none; border-radius: 30px; font-weight: bold; display: inline-block; margin: 10px; box-shadow: 0 4px 10px rgba(37,211,102,0.3);'>Join Community 💬</a>"
                    +
                    "<a href='" + instaLink
                    + "' style='background-color: #E1306C; color: white; padding: 12px 25px; text-decoration: none; border-radius: 30px; font-weight: bold; display: inline-block; margin: 10px; box-shadow: 0 4px 10px rgba(225,48,108,0.3);'>Follow us on Insta 📸</a>"
                    +
                    
                    
                    "</div>" +
                    // Optional: Ek choti line niche
            ...
            System.out.println("Impressive mail sent with " + donationCount + " count to: " + donorName);
